...
public class FollowerConstants {
    ...
    private static double xMovement = 76.121;
    private static double yMovement = 59.9529;
    ...
    public static double mass = 13.69849;
    ...
    public static double forwardZeroPowerAcceleration = -28.3522;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -66.0419;
